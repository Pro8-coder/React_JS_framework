...
const LoyaltyProgram = () => {
  return (
    <div className="registration_inf">
      ...
      <div className="registration_inf_item">
        <div className="registration_inf_str">
          <svg
            className="registration_inf_check-mark"
        ...
        <div class="registration_inf_str">
          <svg
            class="registration_inf_check-mark"
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="16"
            viewBox="0 0 20 16"
