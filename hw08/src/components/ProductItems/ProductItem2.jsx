  ...
  return (
    <div className="product_item">
      <div className="box_img">
        ...
        <img src={Product} alt="product2" className="product_img product_bg" />
        <div className="overlay">
          <button className="add_to_cart">
            <svg
              className="add_to_cart_img"
      ...
      <div className="product_description">
        <h3 className="subtitle">ELLERY X M'O CAPSULE</h3>
        ...
        <p className="product_price">$52.00</p>
      </div>
    </div>
  );
};
